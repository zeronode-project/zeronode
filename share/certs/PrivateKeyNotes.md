...
unlocked to sign the znode-qt.app bundle.
...
allowing somebody to distribute a znode-qt.app or bitcoin-qt-setup.exe with a valid
...
that the znode-qt.exe file inside the installer had not been tampered with.
