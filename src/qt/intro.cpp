...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ZeroNode Core"),
     ...
     * override -datadir in the zeronode.conf file in the default data directory
     * (to be consistent with zeronoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
