                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ZeroNode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZeroNode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and znode: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZeroNode Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZeroNode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZeroNode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZeroNode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZeroNode addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZeroNode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ZeroNode Core help message to get a list with possible ZeroNode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZeroNode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZeroNode network", "", count));
}
...
{
    QString strTitle = tr("ZeroNode Core"); // default title
