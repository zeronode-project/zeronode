...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a ZeroNode address (e.g. %1)").arg("zG123R62NFF2eMN5tSbzbcDQ9gy8JYQfd9"));
#endif
...
void openConfigfile()
{
    ...
    /* Open zeronode.conf with the associated application */
