...
/** Utility functions used by the ZeroNode Qt UI.
 */
namespace GUIUtil
{
...
// Render ZeroNode addresses in monospace font
...
// Parse "znode:" URI into recipient object, return true on successful parsing
