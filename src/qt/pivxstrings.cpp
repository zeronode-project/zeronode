...
QT_TRANSLATE_NOOP("colx-core", "Copyright (C) 2015-%i The Pivx Core Developers"),
QT_TRANSLATE_NOOP("colx-core", "Copyright (C) 2017-%i The ColossusCoinXT Core Developers"),
QT_TRANSLATE_NOOP("colx-core", "Copyright (C) 2018-%i The ZeroNode Core Developers"),
...
QT_TRANSLATE_NOOP("colx-core", "Error loading wallet.dat: Wallet requires newer version of ZeroNode Core"),
...
QT_TRANSLATE_NOOP("colx-core", "Fee (in NODE/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("colx-core", "Initialization sanity check failed. ZeroNode Core is shutting down."),
...
QT_TRANSLATE_NOOP("colx-core", "Keep N NODE anonymized (default: %u)"),
...
QT_TRANSLATE_NOOP("colx-core", "Wallet needed to be rewritten: restart ZeroNode Core to complete"),
