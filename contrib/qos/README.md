...
This means one can have an always-on zeronoded instance running, and another local zeronoded/zeronode-qt instance which connects to this node and receives blocks from it.
