...
This means one can have an always-on znoded instance running, and another local znoded/znode-qt instance which connects to this node and receives blocks from it.
