...
ZeroNode now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
When block `1000000` is reached you'll receive a payment for `1200` zeronode.
