ZeroNode Core version 2.2.1 is now available from:
...
of Bitcoin that ZeroNode was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/node-project-translations/).
