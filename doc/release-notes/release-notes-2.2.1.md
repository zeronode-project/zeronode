zNODE Core version 2.2.1 is now available from:
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/znode-project/znode/issues>

Compatibility
==============

zNODE Core is extensively tested on multiple operating systems using
...
zNODE Core should also work on most other Unix-like systems but is not
...
of Bitcoin that zNODE was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/znode-project-translations/).
