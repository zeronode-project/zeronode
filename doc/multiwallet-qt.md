...
In order to support loading of multiple wallets in zeronode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zeronode.cpp.
...
Changes to zeronode.cpp
----------------------
zeronode.cpp is the entry point into zeronode-qt, and as such, will require some minor modifications to provide hooks for
