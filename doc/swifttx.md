...
This mechanism has been integrated into Bitcore-ZeroNode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zeronode-project/insight-api-zeronode#web-socket-api](https://github.com/zeronode-project/insight-api-zeronode#web-socket-api)
* API: [https://github.com/zeronode-project/insight-api-zeronode#swifttx-transactions](https://github.com/zeronode-project/insight-api-zeronode#swifttx-transactions)
...
By default, the ZeroNode Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ZeroNode Core daemon:
