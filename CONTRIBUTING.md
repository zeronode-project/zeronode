...
The following applies to code changes to the zNODE Core project, and is not to be
confused with overall zNODE Network Protocol consensus changes.

Whether a pull request is merged into zNODE Core rests with the project merge
...
Patches that change zNODE consensus rules are considerably more involved than
...
Where a patch set proposes to change the zNODE consensus, it must have been
...
The project leader is the release manager for each zNODE Core release.
