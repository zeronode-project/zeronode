Contributing to ZeroNode Core
============================

The ZeroNode Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ZeroNode Core project, and is not to be
confused with overall ZeroNode Network Protocol consensus changes.

Whether a pull request is merged into ZeroNode Core rests with the project merge
...
Patches that change ZeroNode consensus rules are considerably more involved than
...
Where a patch set proposes to change the ZeroNode consensus, it must have been
...
The project leader is the release manager for each ZeroNode Core release.
